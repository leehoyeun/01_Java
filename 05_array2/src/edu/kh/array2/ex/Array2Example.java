...
public class Array2Example {
	...
	public void ex1() {
		...
		arr= new int[2][3];
		// heap 영역에 int 2차원 배열 2행 3열짜리 공간을 할당
		// 그 공간의 arr 참조변수 대입
		
		// 2차원의 배열 초기화
		// 1 ) 행,열 인덱스를 이용해서 집적 초기화
//		arr[0][0] = 10 ;
//		arr[0][1] = 20;
//		arr[0][2]= 30 ;
//		
...
//		arr[1][2]=60;
		...
		//Arrays.toString(배열명):참조하고있는 1차원 배열의 값을
		//문자열로 반환
	...
	public void ex3() {
		// 가변 배열
		// -2차원 배열 생성 시 마지막 배열 차수(열_을 지정하지 않고
		...
		arr[1]= new char[4];// 1행에 4열짜리 1차원 배열얼 생성하여 주소값 저장
