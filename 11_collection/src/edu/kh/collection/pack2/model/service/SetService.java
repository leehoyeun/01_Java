...
public class SetService {
	...
	public void method1() {
		...
		// 전달받은 e가 Set에 있으면 true,없으면false
	...
	/**
	 * 집적 만든 클래스(person)을 이용해 만든 객체를 set에 저장(중복 제거 확인)
	 * 
	 */
	public void method3() {
		...
		// A.equals (B) A와B가 가지고있는 필드값이 전부 같다면 true 아니면 false
	 ...
	 * 
	 * *TreeSet 안에 저장되는 객체는 comparable 인터페이스 상속 필수! -> Integer는 Comparable 상속 되어있음
	 * 
	 * 
	 */
	public void method4() {
	...
	public void lottoNumberGenerator() {
		...
		// 생성된 로또 번호 묶음(TreeSet)을 저장한 List 객체 생성
