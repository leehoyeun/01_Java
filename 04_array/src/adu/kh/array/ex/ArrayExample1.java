...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		//변수 대입
		num = 10;
		//생성된 num 이라는 변수 공간에 10이라는 정수값 대입
		
		//변수사용
		System.out.println("num에 저장되는 값 : "+num);
		...
		//new int[3]: heap 영역에 int 형 변수 3칸 짜릴 int[]을 생성(할당)
		...
		// [10,50,100]실제로 arr 배열이 가진 모든 요소의 값을 알고싶은때
		// Arays.toString(배열명);
...
//		System.out.println(arr[2]);
	...
	//배열의 각 요소에 값 대입하는 요도의 반복문
	for(int i= 0;i<height.length;i++) {
		System.out.print((i+1)+"번 키입력 :");//1 2 3 4 5
...
//			score[3]=90
	...
	public void ex6() {
		...
		// -> ! (Not 연산자 : 부정논리 연산자) 붙여줌으로써 true로 변경하여 
		// {}안에있는 코드를 수행하게끔 함.
		if(!flag) {
	...
	public void ex7() {
		...
		for(int i = 0;i<arr.length;i++) {//String 비교시 equals()사용!
	...
	public void ex9() {
		...
		for(int i = 0; i  < arr.length;i++) {
			arr[i]=input.charAt(i);//[h,e,l,l,o]
			//arr[0] = 'h';
			//arr[1] = 'e';
			//arr[2] = 'l';
			//arr[3] = 'l';
