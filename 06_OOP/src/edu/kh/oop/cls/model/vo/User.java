...
public class User {
	...
	// 기본생성자 자동완서 단축키 : ctrl + space +enter
	//기본 생성자( -> 매개변수 없는 생성자)
	public User() {
		//기능
	...
	//[오버로드 조건]
	// 1. 매서드의 이름이 동일
	// 2. 매개변수의 개수 , 타입(자료형),순서중 1개라도 달라야 함.
	
	//public User() {}//기본생성자 이미 작성되어 있어서 X
	
	public User(String userId) {}//매개변수가 개수가 같은 생성자 없음
	// -> 오버로딩 성립
	...
	//1.만약에 재정이할때 오타가 있거나 , 부모 클래스에 없는 메서드를 잘못 작성했을 경우 컴파일 오류 발생
