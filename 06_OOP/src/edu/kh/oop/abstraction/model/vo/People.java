...
//Model- 프로그램 로직과 관련되어있는 데이터를정장하는 용도,+비즈니스 로직
//VO(Value Objact) : 값 저장용 객체를 만들기 위한 클래스를 모아두는 패키지
//View
//Controller
...
public class People {//국민(사람) 클래스
	...
	public void setAge(int age) {
		//메서드(기능) 형태인 getter/setter를 이용하면 본인이 원하는 기능을 추가할수 있음
		//age가 0보다 작을 때 예외 발생시키기
		//age가 0보다 클 때 속성에 전달받은 값 셋팅하기..
	...
	//getter () : 반환형이 무조건 있음
	//			getter는 필드에 작성된 변수값을 호출한 쪽으로 되돌려주는것.
	//			변수는 자료형이 있을 것.
	//			그 변수를 되돌려준다면 당연히 반환형도 존재할 것!
	
	
	// name 변수에 값을 셋팅하는 간접 접근 기능중 setter
