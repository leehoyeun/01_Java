...
public class ObjectService {
	...
	public void objectInput() {
		...
		try {
			...
			//Object ois.readObject () : 직렬화된 객체를 읽어와 역질렬화
								// +Member 객체로 변경(다운캐스팅)
