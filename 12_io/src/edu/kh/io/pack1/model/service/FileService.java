...
public class FileService {
	...
	public void method1() {
		...
		//제일 앞에 "/"의 의미 : 최상의 폴더 (==root,절대 경로의 기준점)
		//리눅스 , mac에서는 Users / , 윈도우에서는 C: / , D:/ 등
		
		// c:/io_test/20250305 폴더를 지성
	...
	public void method2() {
		...
		// ->IoException는 반드시 예외처리를 해야 하는 Checked Exception
		// -> 예외 처리필수!
	...
	public void method3() {
		...
		for(File f:files) {
			...
			//마지막으로 수정한 날짜
			long lastModifien = f.lastModified();
			//System.out.println();
			...
			// 문자열 형태로 반환
			String date = sdf.format(lastModifien);
