...
import edu.kh.poly.ex2.model.service.LHYCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		//=========================
		Calculator cal = new LHYCalculator();
		
		System.out.println("합"+ cal.plus(20, 30));
		System.out.println("차"+cal.minus(100, 20));
		System.out.println("곱"+cal.multiple(30, 2));
		System.out.println("나누기"+cal.divide(15, 3));
		...
		//->이를 이용하여 중요한 메인코드의 수정을 최소화 할 수있다.
